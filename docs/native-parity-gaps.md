...
| Archives | `card_archives.c` and guarded card restore callback; desktop opens panel from Archives section | Native archive panel covers cards, not an archive browser for every hierarchy/entity kind. |

...
test_dir="${TMPDIR:-/tmp}/wena-checklist-mutation-$$"
mkdir -p "$test_dir"
...
cc -std=c89 -pedantic-errors -Wall -Wextra -Werror \
 "$root_dir/tests/checklist_mutation_test.c" "$root_dir/client/features/checklist_mutation.c" "$root_dir/client/features/checklist_store.c" \

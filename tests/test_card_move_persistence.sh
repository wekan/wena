...
cc -std=c89 -pedantic-errors -Wall -Wextra -Werror "$root_dir/tests/card_move_persistence_test.c" "$root_dir/client/features/card_mutation.c" "$root_dir/models/card_order.c" "$root_dir/models/card.c" "$root_dir/models/model.c" "$root_dir/server/sqlite_persistence.c" \

...
cc -std=c89 -pedantic-errors -Wall -Wextra -Werror -I"$root_dir/third_party/nuklear" \
 "$root_dir/tests/nuklear_card_selection_test.c" "$root_dir/client/features/card_selection_panel.c" "$root_dir/models/card_order.c" "$root_dir/client/components/forms/position_input.c" "$root_dir/client/components/forms/hierarchy_destination.c" "$root_dir/client/features/labels/store.c" "$root_dir/client/features/labels/component.c" \

...
int main(int argc,char**argv)
{
 ...
 wena_checklists_close(&s);assert(sqlite3_close(d)==SQLITE_OK);puts("Checklist UI SQLite create, rename, item, completion, rollback, stale, replay and reopen passed");return 0;
}

...
cc -std=c89 -pedantic-errors -Wall -Wextra -Werror "$root_dir/tests/sqlite_hierarchy_create_test.c" "$root_dir/models/model.c" "$root_dir/server/sqlite_persistence.c" "$root_dir/server/mutations/list_archive.c" \

...
int main(void)
{
    ...
    const char *native_operations[] = {
        ...
        "set-selected-person", "transfer-selected-cards", "move-selected-cards", "assign-selected-label", "unassign-selected-label", "archive-selected-cards", "archive-list-cards", "archive-swimlane", "restore-swimlane"
    };
    size_t index;
    int previous_calls;

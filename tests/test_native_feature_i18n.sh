...
cc -std=c89 -pedantic-errors -Wall -Wextra -Werror \
  ...
  "$root_dir/client/features/card_move.c" "$root_dir/models/card_order.c" "$root_dir/client/features/card_archives.c" "$root_dir/client/components/common/paginated_table.c" \

...
cc -std=c89 -pedantic-errors -Wall -Wextra -Werror \
  ...
  "$root_dir/server/sqlite_directory.c" "$root_dir/server/sqlite_persistence.c" "$root_dir/server/mutations/list_archive.c" "$root_dir/server/mutations/checklist_order.c" \

...
test_dir="${TMPDIR:-/tmp}/wena-card-move-reorder-ui-test-$$"
binary="$test_dir/card-move-test"
...
cc -std=c89 -pedantic-errors -Wall -Wextra -Werror \
  ...
  -I"$root_dir/models" \
  "$root_dir/tests/card_move_reorder_ui_test.c" \
  "$root_dir/tests/fakes/nuklear.c" \
  "$root_dir/client/features/board.c" \
  "$root_dir/client/features/card_move.c" "$root_dir/models/card_order.c" \

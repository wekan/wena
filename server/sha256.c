...
typedef struct Sha { U32 h[8]; unsigned char block[64]; size_t used; U32 hi, lo; } Sha;
...
static void add(Sha *s,const unsigned char *p,size_t n)
{
    size_t take;
...
{
    Sha s; unsigned char tail[128]; size_t pad,i; U32 bits_hi,bits_lo; static const char x[]="0123456789abcdef";
    memset(&s,0,sizeof(s));s.h[0]=0x6a09e667ul;s.h[1]=0xbb67ae85ul;s.h[2]=0x3c6ef372ul;s.h[3]=0xa54ff53aul;s.h[4]=0x510e527ful;s.h[5]=0x9b05688cul;s.h[6]=0x1f83d9abul;s.h[7]=0x5be0cd19ul;add(&s,data,length);
    ...
    tail[pad-8]=(unsigned char)(bits_hi>>24);tail[pad-7]=(unsigned char)(bits_hi>>16);tail[pad-6]=(unsigned char)(bits_hi>>8);tail[pad-5]=(unsigned char)bits_hi;tail[pad-4]=(unsigned char)(bits_lo>>24);tail[pad-3]=(unsigned char)(bits_lo>>16);tail[pad-2]=(unsigned char)(bits_lo>>8);tail[pad-1]=(unsigned char)bits_lo;add(&s,tail,pad);
